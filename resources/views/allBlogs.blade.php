...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="symbol symbol-40 symbol-light-success mr-5">
                <span class="symbol-label">
                    <img src="storage/{{$blog->user->profile_photo}}" class="h-75 align-self-end"
                        alt="">
                </span>
            </div>
            <!--end::Symbol-->
            ...
            <div class="d-flex flex-column flex-grow-1">
                <a href="userprofileview/{{$blog->user->id}}"
                    class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">{{$blog->user->name
                    }}</a>
                <span class="text-muted font-weight-bold">By {{$blog->user->name}} on {{
                    Str::substr($blog->user->created_at, 0, 10) }}</span>
            </div>
            <!--end::Info-->
        ...
        <!--begin::Action-->
        <div class="d-flex align-items-center">
            <button id="comment{{$blog->id}}"
                class="commentBlog btn btn-hover-text-primary btn-hover-icon-primary btn-sm btn-text-dark-50 bg-hover-light-primary rounded font-weight-bolder font-size-sm p-2">
                <span class="svg-icon svg-icon-md svg-icon-dark-25 pr-2 ">
                    <!--begin::Svg Icon | path:/metronic/theme/html/demo8/dist/assets/media/svg/icons/Communication/Group-chat.svg--><svg
            ...
            <button id="like{{$blog->id}}" class="likeBlog btn btn-sm btn-text-dark-50 
                ...
                <span class="svg-icon  svg-icon-md  pr-1 ml-2">
                    <!--begin::Svg Icon | path:/metronic/theme/html/demo8/dist/assets/media/svg/icons/General/Heart.svg--><svg
                        xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                        viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            auth()->user()->hasPermissionTo('delete-blog-posts') ||
            auth()->user()->hasRole('admin'))
            <button class="deleteBlog btn btn-sm btn-primary ml-3"
                id="deleteBlog{{$blog->id}}">Delete</button>
            @endif
        </div>
        <!--end::Action-->
        <!--end::Bottom-->
